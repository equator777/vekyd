        ...
        <div className="text-center max-w-3xl mx-auto">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3 mb-10">
            <button
              ...
              className={`btn ${activeTab === 'goods' ? 'btn-primary' : 'btn-secondary'} px-6 py-3 text-sm font-bold shadow-lg`}
            >
            ...
            <button
              ...
              className={`btn ${activeTab === 'trades' ? 'btn-emerald' : 'btn-secondary'} px-6 py-3 text-sm font-bold shadow-lg`}
            >
              <Wrench className="w-4 h-4" />
              <span>Browse Trade Directory</span>
            </button>

            <button
              onClick={openPostGoodsModal}
              className="btn btn-warm px-5 py-3 text-sm font-bold shadow-lg"
            >
            ...
            <button
              ...
              className="btn bg-cyan-600 hover:bg-cyan-500 text-white px-5 py-3 text-sm font-bold shadow-lg shadow-cyan-500/20"
            >
